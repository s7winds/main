...
$(document).ready(function() {
        ...
        $('#fade , #popup-callback, #popup-callback2, #popup-order1, #popup-order2, #popup-order3, #popup-order4, #popup-order5, #popup-order6, #popup-order7, #popup-order8, #popup-order9, #popup-order10, #popup-order11, #popup-order12, #popup-order13, #popup-order14, #popup-order01, #popup-order02, #popup-order').fadeOut()
        return false;
});
        $('#').click(function(){
        facechangemap('#');
