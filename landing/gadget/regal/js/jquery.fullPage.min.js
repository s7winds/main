    ...
    a.fn.fullpage = function(c) {
        ...
        function ia(b) {
            ...
            if (!N(b.target)) {
                ...
                var e = M(b);
                l || t || (d = O(d), r = d.y, y = d.x, b.find(".fp-slides").length && Math.abs(z - y) > Math.abs(s - r) ? Math.abs(z - y) > a(window).width() /
                    100 * c.touchSensitivity && (z > y ? a.fn.fullpage.moveSlideRight() : a.fn.fullpage.moveSlideLeft()) : c.autoScrolling && Math.abs(s - r) > a(window).height() / 100 * c.touchSensitivity && (s > r ? x("down", e) : r > s && x("up", e)))
            }
        }
        ...
        function n(b) {
            if (c.autoScrolling) {
                ...
                var d = Math.max(-1, Math.min(1,
                    b.wheelDelta || -b.deltaY || -b.detail));
        ...
        function V() {
            if (!A) {
                var b = window.location.hash.replace("#", "").split("http://gresso.ru/"),
                    a = b[0],
                    b = b[1];
                if (a.length) {
        ...
        a(".fp-section").each(function(b) {
            ...
            if (1 < f) {
                ...
                a(this).find(".fp-slides").after('<div class="nazad"></div><div class="fp-controlArrow fp-prev"></div><div class="fp-controlArrow fp-next"></div><div class="vpered"></div>');
            ...
            c.navigation && (h.css("margin-left", "-" + h.width() / 2 + "px"), h.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
            ...
            Z();
            b = window.location.hash.replace("#", "").split("http://gresso.ru/")[0];
            if (b.length) {
            ...
            a(window).on("load", function() {
                var a = window.location.hash.replace("#", "").split("http://gresso.ru/"),
                    b = a[0],
                    a = a[1];
                b && F(b, a)
            })
        ...
        c.normalScrollElements &&
            (a(document).on("mouseenter", c.normalScrollElements, function() {
